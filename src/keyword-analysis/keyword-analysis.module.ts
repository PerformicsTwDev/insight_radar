...
/**
 * KeywordAnalysis 模組（T3.2，FR-1）。匯入 {@link QueueModule}（提供 `keyword-analysis` queue 的
 * `@InjectQueue`）+ queue config namespace；提供/匯出 {@link KeywordAnalysisService} 供 controller（T3.3/T3.4）。
 *
